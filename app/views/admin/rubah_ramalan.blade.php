        <div class="panel panel-primary">
          <div class="panel-heading">
            <div class="btn-group pull-right">
              <button type="button" class="btn btn-primary btn-s" id="zodiak" data-zodiak="{{ $ramalan->zodiak }}">{{ $ramalan->zodiak }}</button>
            ...
            <h1 class="panel-title"><strong>Rubah Ramalan</strong></h1>
          </div>
          ...
          <div class="panel-body">
                ...
                <fieldset>
                  ...
                  <div class="form-group" id="form-nomor">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <input type="text" class="form-control" id="nomor" maxlength="10" placeholder="Ketikkan ramalan nomor disini..." value="{{ $ramalan->nomor }}">
              ...
              <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <fieldset>
                  ...
                  <div class="form-group" id="form-warna">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <input type="text" class="form-control" id="warna" maxlength="10" placeholder="Ketikkan ramalan warna disini..." readonly="readonly" value="{{ $ramalan->warna }}">
              ...
              <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <fieldset>
                  ...
                  <div class="form-group" id="form-tanggal">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <input type="text" class="form-control" id="tanggal" maxlength="10" placeholder="Ketikkan tanggal ramalan disini..." readonly="readonly" value="{{ date('d-m-Y', strtotime($ramalan->tanggal)) }}">
              ...
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <fieldset>
                  ...
                  <div class="form-group" id="form-umum">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <textarea class="form-control" id="umum" rows="5" placeholder="Ketikkan ramalan umum disini...">{{ $ramalan->umum }}</textarea>
              ...
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <fieldset>
                  ...
                  <div class="form-group" id="form-asmara">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <textarea class="form-control" id="asmara" rows="5" placeholder="Ketikkan ramalan asmara disini...">{{ $ramalan->asmara }}</textarea>
              ...
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <fieldset>
                  ...
                  <div class="form-group" id="form-karir">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <textarea class="form-control" id="karir" rows="5" placeholder="Ketikkan ramalan karir disini...">{{ $ramalan->karir }}</textarea>
              ...
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <fieldset>
                  ...
                  <div class="form-group" id="form-motivasi">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <textarea class="form-control" id="motivasi" rows="5" placeholder="Ketikkan ramalan motivasi disini...">{{ $ramalan->motivasi }}</textarea>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center" id="col-tambah">
              <button type="button" class="btn btn-primary" data-loading-text="Tunggu..." onclick="rubahRamalan({{ $ramalan->id }})" id="tambah">Simpan</button>
            </div>
